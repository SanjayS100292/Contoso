...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cPassword) {
        $qry = "INSERT INTO `tblcustomer` (`cName`,`cEmail`,`cContact`,`cAddress`,`cDistrict`,`cAge`,`cGender`) VALUES ('$name','$email','$phone','$address','$district','$age','$gender')";
        $qryLog = "INSERT INTO `tbllogin` (`uid`,`username`,`password`,`usertype`,`status`) VALUES ((SELECT MAX(`cId`) FROM `tblcustomer`), '$email','$password','Customer','Active')";
